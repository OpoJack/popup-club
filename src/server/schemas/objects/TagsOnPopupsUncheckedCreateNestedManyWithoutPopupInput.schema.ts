...
const Schema: z.ZodType<Prisma.TagsOnPopupsUncheckedCreateNestedManyWithoutPopupInput> =
  z.union([
    z
      .object({
        create: z
...
export const TagsOnPopupsUncheckedCreateNestedManyWithoutPopupInputObjectSchema =
  Schema;
