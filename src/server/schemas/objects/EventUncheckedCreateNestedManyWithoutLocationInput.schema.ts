...
const Schema: z.ZodType<Prisma.EventUncheckedCreateNestedManyWithoutLocationInput> =
  z.union([
    z
      .object({
        create: z
...
export const EventUncheckedCreateNestedManyWithoutLocationInputObjectSchema =
  Schema;
