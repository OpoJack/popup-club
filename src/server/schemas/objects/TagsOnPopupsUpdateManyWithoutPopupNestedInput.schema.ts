...
const Schema: z.ZodType<Prisma.TagsOnPopupsUpdateManyWithoutPopupNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const TagsOnPopupsUpdateManyWithoutPopupNestedInputObjectSchema = Schema;
