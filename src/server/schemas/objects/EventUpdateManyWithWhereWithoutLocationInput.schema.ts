...
const Schema: z.ZodType<Prisma.EventUpdateManyWithWhereWithoutLocationInput> = z
  .object({
...
export const EventUpdateManyWithWhereWithoutLocationInputObjectSchema = Schema;
