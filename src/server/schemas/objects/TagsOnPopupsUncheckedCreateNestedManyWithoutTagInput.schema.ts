...
const Schema: z.ZodType<Prisma.TagsOnPopupsUncheckedCreateNestedManyWithoutTagInput> =
  z.union([
    z
      .object({
        create: z
...
export const TagsOnPopupsUncheckedCreateNestedManyWithoutTagInputObjectSchema =
  Schema;
