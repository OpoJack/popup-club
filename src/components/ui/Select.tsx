...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'focus:outline-nonedisabled:cursor-not-allowed flex h-10 w-full items-center justify-between rounded-md border border-neutral bg-transparent px-3 py-2 text-sm placeholder:text-neutral placeholder:text-opacity-50 focus:border-secondary disabled:opacity-50 dark:border-slate-700 dark:text-slate-50',
      className
    )}
    {...props}
  >
