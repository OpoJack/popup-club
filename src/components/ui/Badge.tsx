...
const badgeVariants = cva(
  'inline-flex items-center border rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors',
  {
    variants: {
      variant: {
        default: 'bg-primary hover:bg-primary/80 border-transparent text-primary-content',
        secondary: 'bg-secondary hover:bg-secondary/80 border-transparent text-secondary-content',
        destructive:
